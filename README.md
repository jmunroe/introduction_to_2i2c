...
This book introduces the 2i2c platform.
...
We welcome and recognize all contributions. You can see a list of current contributors in the [contributors tab](https://github.com/jmunroe/introduction_to_2i2c/graphs/contributors).
